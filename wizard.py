...
from cryptocoins.coins.ulc import ULC
...
def main():
    ...
    IS_ULC = env('COMMON_TASKS_ULC', default=True, cast=bool)
        ...
        ULC: [
    {
        ...
        'attributes': {
            'name': 'ULC',
            'decimals': 8,
            'index': 28,  # Adjust the index appropriately for ULC
            'tx_explorer': 'https://scan.ultronsmartchain.io/tx/',  # Adjust the explorer URL if needed
            'links': {
                "bt": {"href": "", "title": "BitcoinTalk"},
                "cmc": {"href": "", "title": "CoinMarketCap"},
                "exp": {"href": "", "title": "Explorer"},
                "official": {"href": "", "title": "Official Website"}  # Put the actual URL
            },
            'logo': 'https://example.com/path_to_ulc_logo.png',  # Update the URL to the actual logo
        },
    },
    {
        'model': FeesAndLimits,
